        ...
        <div class="sm:flex sm:items-start">
          <div class="text-center">
            ...
            <div class="mt-2">
              ...
              <a class="text-gray-300 text-lg hover:text-white transition-colors ease-out duration-200 flex" href="{{route('user.settings')}}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-5 mr-1">
              ...
              <form method="POST" action="{{ route('logout') }}">
                @csrf
                <a class="text-gray-300 text-lg hover:text-white transition-colors ease-out duration-200 flex" href="{{route('logout')}}" onclick="event.preventDefault();this.closest('form').submit();">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-5 mr-1">
...
<nav class="navbar-main fixed w-full z-10">
    <div class="flex justify-between mx-auto max-w-screen-md py-2 items-center">
        ...
        <a class="text-gray-300 text-sm hover:text-white transition-colors ease-out duration-200 flex" href="{{route('redirect.discord')}}">
            ...
            News</a>
        <a class="text-gray-300 text-sm hover:text-white transition-colors ease-out duration-200 flex" href="/about">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-5 mr-1">
