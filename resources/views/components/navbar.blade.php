    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      <!--
        ...
        Leaving: "ease-in duration-200"
          ...
          To: "opacity-0"
      -->
      <div class="fixed inset-0 transition-opacity ease-out duration-300 modal-bg opacity-0" data-modal="#my-account-modal" id="my-account-modal-bg" aria-hidden="true">
      ...
      -->
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95 ease-out duration-300" role="dialog" aria-modal="true" aria-labelledby="modal-headline" id="my-account-modal">
