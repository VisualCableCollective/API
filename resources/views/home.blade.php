...
@section('content')
@parent
<div class="top-banner bg-cover bg-no-repeat text-white" style="min-height: 100vh;background-image: url('/img/bg/electrify-ngd.jpg')">
    <div class="flex items-center justify-items-center w-full min-h-screen bg-black/30">
        <div class="mx-auto text-center">
            <h1 class="text-3xl sm:text-6xl font-bold pb-2">It's going to be ⚡️</h1>
