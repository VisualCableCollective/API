...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="top-banner bg-home-1 bg-cover parallax text-white flex items-center justify-items-center" style="height: 100vh;">
        ...
        <div class="top-banner bg-black" style="height: 100vh;">
        </div>
    </body>
</html>
